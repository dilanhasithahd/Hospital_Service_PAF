...
(511, 'Asiri', 'Asiri Hospitals, kurunegala.', 'asiriihospitals@gmail.com', '0121212122', '3000.00'),
(512, 'MediCare Hospitals', 'MediCare Hospitals, Matara', 'mchospitals@gmail.com', '0412323233', '1400.00');
...
--
ALTER TABLE `hospital`
  MODIFY `hospital_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=515;
COMMIT;
