...
public class HospitalsAPI extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		String output = hosObj.AddHospitals(request.getParameter("hosName"),
	...
	protected void doPut(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String output = hosObj.updateHospital(paras.get("hidHosIDSave").toString(),
	...
	protected void doDelete(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String output = hosObj.removeHospitals(paras.get("hidHosIDDelete").toString());
	}
